...
namespace XjzzDatabase.Logic
{
    internal class RoleActions
    {
        internal void AddUserAndRole()
        {
            ...
            if (!userMgr.IsInRole(userMgr.FindByName("admin").Id, "Administrator"))
            {
                IdUserResult = userMgr.AddToRole(userMgr.FindByName("admin").Id, "Administrator");
            }
        }
    }
}